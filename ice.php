...
<div class="pokemon">
<img class="typeimg" src="./fotos/IceType.png" width="100px">
<h1 class="titel"> Ice </h1> 
<h1 class="titel2"> (Type) </h1>


<p class="typedescription">Ice type Pokémon are now the rarest of all types: there are only around 60 in total 
