...
<div class="pokemon">
<img class="typeimg" src="./fotos/FireType.png" width="100px">
<h1 class="titel"> Fire </h1> 
<h1 class="titel2"> (Type) </h1>


<p class="typedescription">Fire is one of the three basic elemental types along with Water and Grass, 
