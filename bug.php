...
<div class="pokemon">
<img class="typeimg" src="./fotos/BugType.png" width="100px">
<h1 class="titel"> Bug </h1> 
<h1 class="titel2"> (Type) </h1>


<p class="typedescription"> Most Bug Pokémon grow quickly and evolve sooner than other types. As a result, they are often very weak.
