...
<div class="pokemon">
<img class="typeimg" src="./fotos/DarkType.png" width="100px">
<h1 class="titel"> Dark </h1> 
<h1 class="titel2"> (Type) </h1>


<p class="typedescription"> The Dark type was introduced in the second generation of Pokémon games as a measure to balance the types.
