...
<div class="pokemon">
<img class="typeimg" src="./fotos/GrassType.png" width="100px">
<h1 class="titel"> Grass </h1> 
<h1 class="titel2"> (Type) </h1>


<p class="typedescription"> Grass is one of the three basic elemental types along with Fire and Water, 
